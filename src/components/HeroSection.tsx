      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-6">
            <div className="space-y-4 opacity-0 animate-slide-in-up" style={{ animationDelay: '0.3s' }}>
              <ColorfulBanner date="14TH MARCH" time="10:00 AM ONWARDS" />
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold leading-tight mt-6 opacity-0 animate-slide-in-up" style={{ animationDelay: '0.5s' }}>
              Pune's Biggest <br />
              <span className="text-gradient">Colour Blast</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 opacity-0 animate-slide-in-up" style={{ animationDelay: '0.7s' }}>
              Ek Ticket, Hazaar Rang – Aajao Colour Blast Ke Sang!
            </p>
            
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 justify-center lg:justify-start mt-8 opacity-0 animate-slide-in-up" style={{ animationDelay: '0.9s' }}>
              <a href="#tickets" className="holi-btn-gradient hover-lift">
                Book Tickets
              </a>
              <Link to="/about" className="holi-btn-secondary hover-lift">
                Learn More
              </Link>
            </div>
          </div>
          ...
          <div className="hidden lg:block relative opacity-0 animate-fade-in" style={{ animationDelay: '1s' }}>
            <div className="relative hover-lift">
              ...
              />
              <div className="absolute -bottom-5 -right-5 bg-white/80 backdrop-blur-md rounded-xl p-4 border border-white/50 shadow-xl z-20 opacity-0 animate-slide-in-right animate-soft-bounce" style={{ animationDelay: '1.3s' }}>
